...
Name|Description
----|-----------
[RemixAppProject](#remix-project-remixappproject)|*No description*
...
Name|Description
----|-----------
[RemixAppProjectOptions](#remix-project-remixappprojectoptions)|*No description*
...
Name|Description
----|-----------
[RemixDeploymentProvider](#remix-project-remixdeploymentprovider)|Which deployment provider to use.



## class RemixAppProject 🔹 <a id="remix-project-remixappproject"></a>
...
```ts
new RemixAppProject(options: RemixAppProjectOptions)
```

* **options** (<code>[RemixAppProjectOptions](#remix-project-remixappprojectoptions)</code>)  *No description*
  ...
  * **appDirectory** (<code>string</code>)  *No description* __*Optional*__
  * **browserBuildDirectory** (<code>string</code>)  *No description* __*Optional*__
  * **depolymentProvider** (<code>[RemixDeploymentProvider](#remix-project-remixdeploymentprovider)</code>)  *No description* __*Optional*__
  * **devServerPort** (<code>number</code>)  *No description* __*Optional*__
  * **publicPath** (<code>string</code>)  *No description* __*Optional*__
  * **remixVersion** (<code>string</code>)  *No description* __*Optional*__
  * **serverBuildDirectory** (<code>string</code>)  *No description* __*Optional*__
  * **tailwind** (<code>boolean</code>)  *No description* __*Optional*__
...
-----|------|-------------
**appDirectory**🔹 | <code>string</code> | <span></span>
**browserBuildDirectory**🔹 | <code>string</code> | <span></span>
**deploymentProvider**🔹 | <code>[RemixDeploymentProvider](#remix-project-remixdeploymentprovider)</code> | <span></span>
**devServerPort**🔹 | <code>number</code> | <span></span>
**publicPath**🔹 | <code>string</code> | <span></span>
**remixConfigFile**🔹 | <code>[FileBase](#projen-filebase)</code> | <span></span>
**remixVersion**🔹 | <code>string</code> | <span></span>
**serverBuildDirectory**🔹 | <code>string</code> | <span></span>
**tailwind**🔹 | <code>boolean</code> | <span></span>



## struct RemixAppProjectOptions 🔹 <a id="remix-project-remixappprojectoptions"></a>
...
**appDirectory**?🔹 | <code>string</code> | __*Optional*__
...
**browserBuildDirectory**?🔹 | <code>string</code> | __*Optional*__
...
**depolymentProvider**?🔹 | <code>[RemixDeploymentProvider](#remix-project-remixdeploymentprovider)</code> | __*Optional*__
...
**devServerPort**?🔹 | <code>number</code> | __*Optional*__
...
**publicPath**?🔹 | <code>string</code> | __*Optional*__
...
**remixVersion**?🔹 | <code>string</code> | __*Optional*__
...
**serverBuildDirectory**?🔹 | <code>string</code> | __*Optional*__
...
**tailwind**?🔹 | <code>boolean</code> | __*Optional*__
...
## enum RemixDeploymentProvider 🔹 <a id="remix-project-remixdeploymentprovider"></a>
